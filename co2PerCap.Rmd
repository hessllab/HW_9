...
ANSWER:
Yes, it is. The CSV file is composed of 192 rows and 216 columns, which contains co2 emission data of 192 countries for 215 years until 2014. Each row represents one country and each column corresponds to CO2 observation in a year. 
```{r}
